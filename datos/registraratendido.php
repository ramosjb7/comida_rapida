...
//valor1=$nombrev&valor2=$correov&valor3=$nombreproductv&valor4=$decripcionv&valor5=$preciov&valor6=$cantidadv&valor7=$totalv
   ...
   // $apellidop = $_GET['valor8'];
    ...
    $totalp = $_GET['valor7'];
        ...
        $query = "INSERT INTO histofactura(nombre,correo,nompreproducto,descripcion,precio,cantidad,total) values ('$nombrep','$correop','$nombreprodcup','$descripcionp','$preciop','$cantidadp','$totalp')";
        ...
        if(mysqli_query($conexion,$query)){
            ...
            ");
            if (!$resulte = mysqli_query($conexion,$result)) {
